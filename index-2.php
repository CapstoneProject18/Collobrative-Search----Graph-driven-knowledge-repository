			...
			<div class="row fullscreen d-flex align-items-center justify-content-center">
				<div class="banner-content col-lg-8 col-md-12">
					...
					<div class="input-wrap">
						<form action="search-results.php" class="form-box d-flex justify-content-between autocomplete" autocomplete="off">
					...
					<div class="courses pt-20">
						<a href="search-results.php?myCountry=Photography&submit=" data-wow-duration="1s" data-wow-delay=".3s" class="primary-btn transparent mr-10 mb-10 wow fadeInDown">Photography
						</a>
						<a href="search-results.php?myCountry=Music&submit=" data-wow-duration="1s" data-wow-delay=".6s" class="primary-btn transparent mr-10 mb-10 wow fadeInDown">Music</a>
						<a href="search-results.php?myCountry=Movies&submit=" data-wow-duration="1s" data-wow-delay=".9s" class="primary-btn transparent mr-10 mb-10 wow fadeInDown">Movies</a>
						<a href="search-results.php?myCountry=Coding&submit=" data-wow-duration="1s" data-wow-delay="1.2s" class="primary-btn transparent mr-10 mb-10 wow fadeInDown">Coding
							
						</a>
						<a href="search-results.php?myCountry=Machine Learning&submit=" data-wow-duration="1s" data-wow-delay="1.5s" class="primary-btn transparent mr-10 mb-10 wow fadeInDown">Machine Learning</a>
						<a href="search-results.php?myCountry=Data Science&submit=" data-wow-duration="1s" data-wow-delay="1.8s" class="primary-btn transparent mr-10 mb-10 wow fadeInDown">Data
							Science
						</a>
						<a href="search-results.php?myCountry=Cryptocurrency&submit=" data-wow-duration="1s" data-wow-delay="2.1s" class="primary-btn transparent mr-10 mb-10 wow fadeInDown">Cryptocurrency</a>
					</div>
				</div>
			</div>
		</div>
